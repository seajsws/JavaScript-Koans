...
test('if', function() {
        ...
        equal(isPositive, __, 'what is the value of isPositive?');
});
...
test('for', function() {
        ...
        equal(counter, __, 'what is the value of counter?');
});
...
test('ternary operator', function() {
        ...
        equal(fruit, __, 'what is the value of fruit?');

        fruit = false ? 'apple' : 'orange';
        equal(fruit, __, 'now what is the value of fruit?');
});
